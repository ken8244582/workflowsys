  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleAdd} className="bg-[#1e3a5f] hover:bg-[#1e3a5f]/90">
                      ...
                      <tr key={p.id} className="border-b last:border-0 hover:bg-muted/30">
                        ...
                        <td className="whitespace-nowrap px-3 py-2 text-xs">
                          <div className="flex items-center gap-2">
                            <button className="text-muted-foreground hover:text-[#1e3a5f] transition-colors" title="编辑" onClick={() => handleEdit(p)}>
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>
                            </button>
                            <button className="text-muted-foreground hover:text-[#dc2626] transition-colors" title="删除" onClick={() => setDeleteId(p.id)}>
